...
function StampCard({ tag }: { tag: string }) {
  return (
    <div
      className="relative flex h-24 w-24 shrink-0 items-center justify-center rounded-md bg-cream p-2 shadow-[var(--shadow-card)]"
      style={{
        backgroundImage:
